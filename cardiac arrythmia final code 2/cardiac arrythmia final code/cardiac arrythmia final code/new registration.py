...
Registration_frame=tk.Frame(window,bg="#B8E2F2")
Registration_frame.place(x=100,y=30, width=500, height=730)
logolbl=tk.Label(Registration_frame,text="Registration Form", font=("Times new roman", 30, "bold"), bg="#B8E2F2", fg="white",bd=0).place(x=100,y=30)

# that is for label1 registration

l2 = tk.Label(Registration_frame, text="Full Name :", width=14, font=("calibri", 15, "bold"), bg="snow")
l2.place(x=50, y=120)
...
l3 = tk.Label(Registration_frame, text="Address :", width=14, font=("calibri", 15, "bold"), bg="snow")
l3.place(x=50, y=170)
...
l5 = tk.Label(Registration_frame, text="E-mail :", width=14, font=("calibri", 15, "bold"), bg="snow")
l5.place(x=50, y=220)
t4 = tk.Entry(Registration_frame, textvar=Email, width=20, font=('', 15))
t4.place(x=240, y=220)
# that is for email address

l6 = tk.Label(Registration_frame, text="Phone number :", width=14, font=("calibri", 15, "bold"), bg="snow")
l6.place(x=50, y=270)
t5 = tk.Entry(Registration_frame, textvar=Phoneno, width=20, font=('', 15))
t5.place(x=240, y=270)
# phone number
l7 = tk.Label(Registration_frame, text="Gender :", width=14, font=("calibri", 15, "bold"), bg="snow")
l7.place(x=50, y=320)
# gender
...
l8 = tk.Label(Registration_frame, text="Age :", width=14, font=("calibri", 15, "bold"), bg="snow")
l8.place(x=50, y=370)
t6 = tk.Entry(Registration_frame, textvar=age, width=20, font=('', 15))
t6.place(x=240, y=370)

l4 = tk.Label(Registration_frame, text="User Name :", width=14, font=("calibri", 15, "bold"), bg="snow")
l4.place(x=50, y=420)
t3 = tk.Entry(Registration_frame, textvar=username, width=20, font=('', 15))
t3.place(x=240, y=420)

l9 = tk.Label(Registration_frame, text="Password :", width=14, font=("calibri", 15, "bold"), bg="snow")
l9.place(x=50, y=470)
t9 = tk.Entry(Registration_frame, textvar=password, width=20, font=('', 15), show="*")
t9.place(x=240, y=470)

l10 = tk.Label(Registration_frame, text="Confirm Password:", width=16, font=("calibri", 15, "bold"), bg="snow")
